        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-around sm:items-center p-10 grow-1">
          <div className="flex flex-col gap-[30px] sm:w-[360px] lg:w-[460px]">
            ...
            <div className="flex gap-[30px] w-full justify-center md:justify-start">
              ...
              <a href="/frontend-cv.pdf" download="cv-fe.pdf" className="bg-black rounded-2xl p-2 w-[150px] h-[40px] text-white flex items-center justify-center cursor-pointer">CV <Image width={100} height={100} alt="download" src="/arcticons.png"/></a>
            </div>
          </div>
